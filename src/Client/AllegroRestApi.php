...
namespace AwemaPL\AllegroClient\Client;
/**
 * Used namespaces
 */
 ...
 *
 * // More examples
 * https://github.com/swdreams/allegro-client-api-1
 *
...
class AllegroRestApi
{
     ...
     */
    const SANDBOX_URL = 'https://api.allegro.pl.allegro-clientsandbox.pl';
    ...
    {
        $url = (!$sandbox) ? 'https://allegro.pl/auth/oauth/authorize' : 'https://allegro.pl.allegro-clientsandbox.pl/auth/oauth/authorize';
        return $url
            . "?response_type=code"
            . "&client_id=$clientId"
     ...
     *
     * @param string $code Code from allegro-client
    ...
    public static function generateToken($code, $clientId, $clientSecret, $redirectUri, $sandbox = false)
    {
        ...
        $url = (!$sandbox) ? 'https://allegro.pl/auth/oauth/token' : 'https://allegro.pl.allegro-clientsandbox.pl/auth/oauth/token';
        // Returning response
